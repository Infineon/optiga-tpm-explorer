...
class Tab5Frame(wx.Frame):
    def __init__(self, parent, title):
        ...
        button_gen_ek = wx.Button(self, -1, 'Generate EK, if not created yet')
        button_gen_ak = wx.Button(self, -1, 'Generate AK from EK')
        button_gen_quote = wx.Button(self, -1, 'Generate Quote')
        button_evictak = wx.Button(self, -1, 'Evict AK/EK handle')
#         button_verify_quote_ssl = wx.Button(self, -1, 'Step 3: Verify Quote (OpenSSL)')
        button_verify_quote_tpm = wx.Button(self, -1, 'Verify Quote (By TPM2-Tools)')
        ...
        first_column.Add((5, 5))
        first_column.Add(server_image, 0, wx.EXPAND | wx.ALL, 5)
#         first_column.Add(button_verify_quote_ssl, 0, wx.EXPAND | wx.ALL, 5)
        first_column.Add(button_verify_quote_tpm, 0, wx.EXPAND | wx.ALL, 5)
        second_column.Add(combimage, 0)
        third_column.Add(button_gen_ak, 0, wx.EXPAND | wx.ALL, 5)
        third_column.Add((5, 5))
        third_column.Add(tpm_image, 0, wx.EXPAND | wx.ALL, 5)
        third_column.Add((5, 5))
        third_column.Add(button_gen_quote, 0, wx.EXPAND | wx.ALL, 5)

        # settings sizer
        settings_sizer.Add(settings_blurb, 0, wx.EXPAND | wx.ALL, 5)
        settings_sizer.Add(pcr_sizer, 0, wx.EXPAND | wx.ALL, 0)
        pcr_sizer.Add(pcr_bank_blurb, 0, wx.ALIGN_CENTRE | wx.ALL, 0)
        pcr_sizer.Add(self.pcr_bank_choice, 0, wx.EXPAND | wx.ALL, 5)
        settings_sizer.Add(nonce_sizer, 0, wx.EXPAND | wx.ALL, 0)
        nonce_sizer.Add(nonce_blurb, 0, wx.ALIGN_CENTRE | wx.ALL, 0)
        nonce_sizer.Add(self.nonce_input, 0, wx.EXPAND | wx.ALL, 5)
        settings_sizer.Add(ek_sizer, 0, wx.EXPAND | wx.ALL, 0)
        ek_sizer.Add(ek_blurb, 0, wx.ALIGN_CENTRE | wx.ALL, 0)
        ek_sizer.Add(button_gen_ek, 0, wx.EXPAND | wx.LEFT, 5)
        settings_sizer.Add(ak_sizer, 0, wx.EXPAND | wx.ALL, 0)
        ak_sizer.Add(ak_blurb, 0, wx.ALIGN_CENTRE | wx.ALL, 0)
        ak_sizer.Add(self.ak_handle_input, 1, wx.EXPAND | wx.ALL, 5)
        ak_sizer.Add(button_evictak, 1, wx.EXPAND | wx.ALL, 5)

        settings_sizer.Add(list_persist_sizer, 0, wx.EXPAND | wx.ALL, 0)
        list_persist_sizer.Add(button_listpersist, 0, wx.EXPAND | wx.ALL, 0)
