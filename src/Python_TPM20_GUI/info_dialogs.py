...
class HandlesInfoDlg(wx.MessageDialog):
    def __init__(self, parent, title):
        wx.MessageDialog.__init__(
            self, parent, message="", caption=title, style=wx.OK | wx.ICON_INFORMATION
        )
        self.SetMessage(
            "Object Handles are in hex, and are 4 bytes (32 bits) long. E.g. 0x8100000F\n\nTransient Object Handles:\n\
...
class CloudDemoInfoDlg(wx.MessageDialog):
    def __init__(self, parent, title):
        ...
        self.SetMessage(
            "TPM Use Case with Amazon Web Services Internet-of-Things (AWS IoT):\n\
